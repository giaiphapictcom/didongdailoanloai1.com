                    ...
                    foreach ($advs as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <embed src="<?php echo IMAGEAD; ?>logo/<?php echo $value['Advertisement']['images']; ?>" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent" width="150" height="150" scale="ExactFit"> </embed>
                                <?php } else { ?>
                                <a href="<?php echo $value['Advertisement']['link']; ?>" target="_blank"><img src="<?php echo IMAGEAD; ?>logo/<?php echo $value['Advertisement']['images']; ?>" height="150" width="150" /></a>
                                <?php } ?>
                            </td>
