        ...
        <div class="tab-content default-tab" id="tab1">
            <table class="input">
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Catproduct.name', array('class'=>'text-input medium-input')); ?></td>
                </tr>
                <tr>
                    <td width="120" class="label">Mã chuyến bay:</td>
                    <td><?php echo $this->Form->input('Catproduct.code', array('class'=>'text-input medium-input')); ?></td>
                </tr>
<!--               <tr>
                    <td width="120" class="label">Tên Danh mục (English):</td>
                    <td><?php echo $this->Form->input('Catproduct.name.eng', array('class'=>'text-input medium-input')); ?></td>
                </tr>-->
  <!--               <tr>
