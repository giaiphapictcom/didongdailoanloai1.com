<?php echo $this->Form->create(null, array( 'url' => DOMAINAD.'supports/add', 'type' => 'post','name' => 'image', 'inputDefaults' => array('label' => false,'div' => false)));?>
<div id="khung">
    <div id="main">
        ...
        <div class="pagetitle icon-48-category-add">
			<h2>Thêm mới hỗ trợ trực tuyến</h2>
        </div>
        <div class="clr"></div>
    </div>
</div>
        ...
        <div class="tab-content default-tab" id="tab1">
            <table width="100%" class="input">
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Support.name',array('class'=>'text-input medium-input','maxlength' => '250','onchange' => 'get_alias()','id' => 'idtitle'));?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Support.telephone', array('class' => 'text-input medium-input', 'id' => 'idtitle')); ?></td>
                </tr>
                <tr>
