...
<div id="khung">
    <div id="main">
        <div class="toolbar-list" id="toolbar">
            <ul>
                <li id="toolbar-new"> <a href="<?php echo DOMAINAD; ?>catalogues/add/<?php echo $catId; ?>" class="toolbar"> <span class="icon-32-new"></span> Thêm mới </a> </li>
            ...
            <tr>
                ...
                <td><select name="listCat" id="jumpMenu" onchange="MM_jumpMenu('parent', this, 0)">
                        ...
                        <?php foreach ($list_cat as $k => $v) { ?>
                            <option value="<?php echo DOMAINAD; ?>catalogues/index/<?php echo $k; ?>" <?php
                            if ($catId == $k) {
                    ...
                    foreach ($Catalogue as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><?php
                                ...
                                ?></td>
                            <td></td>
                            <td><a href="<?php echo DOMAINAD ?>catalogues/index/<?php echo $value['Catalogue']['id']; ?>" title="Edit"> <?php echo $value['Catalogue']['name']; ?> </a></td>
                            ...
                            <td>
                                <label><input type="radio" name="hot[<?php echo $value['Catalogue']['id']; ?>]" value="1" id="sphot_0" <?php if ($value['Catalogue']['hot'] == 1) {
                                echo 'checked';
                            } ?>> Có</label>
                                <label><input name="hot[<?php echo $value['Catalogue']['id']; ?>]" type="radio" id="sphot_1" value="0" <?php if ($value['Catalogue']['hot'] == 0) {
                                echo 'checked';
                            } ?>>  Không</label>
                            </td>
                            <td><?php echo date('d-m-Y', strtotime($value['Catalogue']['modified'])); ?></td>
                            <td><!-- Icons --> 
                                <a href="<?php echo DOMAINAD ?>catalogues/edit/<?php echo $value['Catalogue']['id'] ?>/<?php echo $value['Catalogue']['parent_id']; ?>" title="Sửa mục này"><img src="<?php echo DOMAINAD ?>images/icons/pencil.png" alt="Sửa" /></a> <a href="javascript:confirmDelete('<?php echo DOMAINAD ?>catalogues/delete/<?php echo $value['Catalogue']['id'] ?>/<?php echo $value['Catalogue']['parent_id']; ?>')" title="Xóa mục này"><img src="<?php echo DOMAINAD ?>images/icons/cross.png" alt="Xóa" /></a>
                            <?php if ($value['Catalogue']['status'] == 1) { ?>
                                    <a href="<?php echo DOMAINAD ?>catalogues/close/<?php echo $value['Catalogue']['id'] ?>/<?php echo $value['Catalogue']['parent_id']; ?>" title="Tích vào để không hiển thị mục này" class="icon-4 info-tooltip"><img src="<?php echo DOMAINAD ?>images/icons/success-icon.png" alt="Ngắt kích hoạt" /></a>
                        <?php } else { ?>
                                    <a href="<?php echo DOMAINAD ?>catalogues/active/<?php echo $value['Catalogue']['id'] ?>/<?php echo $value['Catalogue']['parent_id']; ?>" title="Tích vào để không hiển thị mục này" class="icon-4 info-tooltip"><img src="<?php echo DOMAINAD ?>images/icons/Play-icon.png" alt="Ngắt kích hoạt" /></a>
    <?php } ?>
                            </td>
