...
<!--                <tr>
                    <td class="label">Địa chỉ: (English)</td>
                    <td>
                        <?php
                        $CKEditor = new CKEditor();
                        CKFinder::SetupCKEditor($CKEditor);
                        $initialValue = $edit['Setting']['address_eng'];
                        echo $CKEditor->editor("data[Setting][address_eng]", $initialValue, "");
                        ?>
                    </td>
                </tr>-->
<!--                <tr>
                    ...
                    <td>
                        ...
                        $CKEditor = new CKEditor();
                        CKFinder::SetupCKEditor($CKEditor);
                        $initialValue = $edit['Setting']['copyright'];
                        echo $CKEditor->editor("data[Setting][copyright]", $initialValue, "");
                        ?>
                    </td>
                </tr>-->
<!--                <tr>
...
<!--                <tr>
                    <td class="label">Thông tin liên hệ (English)</td>
                    <td>
                        <?php
                        $CKEditor = new CKEditor();
                        CKFinder::SetupCKEditor($CKEditor);
                        $initialValue = $edit['Setting']['contactinfo_eng'];
                        echo $CKEditor->editor("data[Setting][contactinfo_eng]", $initialValue, "");
                        ?>
                    </td>
               	</tr>-->
                <tr>
                    <td class="label">Google map:</td>
                    <td>
                        <?php echo $this->Form->input('Setting.youtube', array('type' => 'textarea', 'rows' => '4')); ?>
                    </td>
                </tr>
                <tr>
                    <td class="label">Google analytics:</td>
                    <td>
                        <?php echo $this->Form->input('Setting.analytics', array('type' => 'textarea', 'rows' => '4')); ?>
                    </td>
                </tr>
                <tr>
