<?php echo $this->Form->create(null, array('url' => DOMAINAD . 'administrators/changepass', 'type' => 'post', 'name' => 'adminForm')); ?>
<div id="khung">
    <div id="main">
            ...
            <table class="input">
               	<tr>
                    ...
                    <td>
                        ...
                        <?php echo $this->Form->input('Administrator.name', array('label' => '', 'class' => 'text-input medium-input', 'maxlength' => '250', 'id' => 'name', 'readonly')); ?>
                    </td>
                </tr>
                <tr>
