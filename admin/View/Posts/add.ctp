        ...
        <div class="tab-content default-tab" id="tab1">
            <table width="100%" class="input">
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Post.name',array('label'=>'','class'=>'text-input medium-input'));?></td>
                </tr>
<!--                <tr>
                    <td width="145" class="label">Tiêu đề (English)</td>
                    <td><?php echo $this->Form->input('Post.name.eng',array('label'=>'','class'=>'text-input medium-input'));?></td>
                </tr>-->
                <tr>
