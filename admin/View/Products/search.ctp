            ...
            <tr>
                ...
                <td><select name="listCat" id="jumpMenu">
                        ...
                        <?php foreach ($list_cat as $k => $v) { ?>
                            <option value="<?php echo $k; ?>" <?php if ($this->Session->read('catId') == $k) {
            ...
            <table width="100%">
                    <thead>
                        <tr>
                            ...
                            <th width="10%" style="text-align:center;"><a href="#" onclick="changepos()">Vị trí</a></th>
                            <th width="10%" style="text-align:center;"><a href="#" onclick="changepos()">SP mớií</a></th>
                            <th width="10%" style="text-align:center;"><a href="#" onclick="changepos()">SP TB</a></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;"><img src="<?php echo IMAGEAD; ?>product/<?php echo $value['Product']['images']; ?>" height="100"></td>
                            ...
                            <td>
                                <label><input type="radio" name="sphot[<?php echo $value['Product']['id']; ?>]" value="1" id="sphot_0" <?php if($value['Product']['hot'] == 1) {echo 'checked';} ?>> Có</label>
                                <label><input name="sphot[<?php echo $value['Product']['id']; ?>]" type="radio" id="sphot_1" value="0" <?php if($value['Product']['hot'] == 0) {echo 'checked';} ?>>  Không</label>
                            </td>
                            <td>
                                <label><input type="radio" name="sphome[<?php echo $value['Product']['id']; ?>]" value="1" id="sphot_0" <?php if($value['Product']['new'] == 1) {echo 'checked';} ?>> Có</label>
                                <label><input name="sphome[<?php echo $value['Product']['id']; ?>]" type="radio" id="sphot_1" value="0" <?php if($value['Product']['new'] == 0) {echo 'checked';} ?>>  Không</label>
                            </td>
