<?php echo $this->Form->create(null, array( 'url' => DOMAINAD.'news/add','type' => 'post','enctype'=>'multipart/form-data','name'=>'image',  'inputDefaults' => array('label' => false,'div' => false))); ?>
        ...
        <div class="tab-content default-tab" id="tab1">
            <table width="100%" class="input">
                <tr>
                    ...
                    <td><?php echo $this->Form->input('News.name',array('label'=>'','class'=>'text-input medium-input'));?></td>
                </tr>
<!--                <tr>
                    <td width="145" class="label">Tiêu đề (English)</td>
                    <td><?php echo $this->Form->input('News.name.eng',array('label'=>'','class'=>'text-input medium-input'));?></td>
                </tr>-->
                <tr>
...
<!--                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo $this->Form->input('News.title_seo',array('label'=>'','class'=>'text-input medium-input'));?></td>
                </tr>
                <tr>
