            ...
            <table width="100%">
                    <thead>
                        <tr>
                            ...
                            <th width="33%" style="text-align:center;">Tiêu đề tin</th>
                            <th width="11%" style="text-align:center;"><a href="#" onclick="changepos()">Vị trí</a></th>
                            <th width="11%" style="text-align:center;"><a href="#" onclick="changepos()">Tin hot</a></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo DOMAINAD ?>news/edit/<?php echo $value['News']['id']; ?>" title="Edit"><?php echo $value['News']['name']; ?></a>  <?php if(date('Y-m-d', strtotime($value['News']['modified'])) == date('Y-m-d')) { ?><img src="<?php echo DOMAINAD ?>images/icons/iconnew.gif" alt="News" /><?php } ?></td>
                            ...
                            <td>
                                ...
                                <label><input name="sphot[<?php echo $value['News']['id']; ?>]" type="radio" id="sphot_1" value="0" <?php if($value['News']['hot'] == 0) {echo 'checked';} ?>>  Không</label>
                            </td>
<!--                            <td>
                                <label><input type="radio" name="sphome[<?php echo $value['News']['id']; ?>]" value="1" id="sphot_0" <?php if($value['News']['new'] == 1) {echo 'checked';} ?>> Có</label>
                                <label><input name="sphome[<?php echo $value['News']['id']; ?>]" type="radio" id="sphot_1" value="0" <?php if($value['News']['new'] == 0) {echo 'checked';} ?>>  Không</label>
                            </td>-->
