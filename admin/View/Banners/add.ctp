<?php echo $this->Form->create(null, array( 'url' => DOMAINAD.'banners/add','type' => 'post','enctype'=>'multipart/form-data','name'=>'image')); ?>
<div id="khung">
    <div id="main">
    ...
    <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
            <table width="100%" class="input">
                ...
                <tr>
                    <td width="150" class="label">Chiều rộng</td>
                    <td><?php echo $this->Form->input('Banner.width',array('label' => '', 'class'=>'text-input medium-input', 'id' => ''));?></td>
                </tr>
                <tr>
                    <td width="150" class="label">Chiều cao</td>
                    <td><?php echo $this->Form->input('Banner.height',array('label' => '', 'class'=>'text-input medium-input', 'id' => ''));?></td>
                </tr>
            </table>
            <div class="clear"></div>
        </div>
